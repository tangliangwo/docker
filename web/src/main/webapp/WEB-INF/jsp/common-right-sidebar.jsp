			...
			<div class="right-sidebar-main">
				<div class="right-sidebar-panel">
									...
									<div class="sidebar-user-info">
										...
										<div class="SZY-USER-NOT-LOGIN" style="">
											...
											<p>
												...
												|
												<a href="/sso/reg" class="color">注册</a>
											</p>
										</div>
										<!-- 没有登录的情况 _end -->
										<!-- 有登录的情况 _start -->
					...
					<span class="SZY-USER-LAST-LOGIN"></span>
												...
												<a href="http://127.0.0.1:8082" class="btn account-btn" target="_blank">个人中心</a>
												<a href="http://127.0.0.1:8082/trade/order" class="btn order-btn" target="_blank">订单中心</a>
											</p>
										</div>
										<!-- 有登录的情况 _end -->
									</div>
							...
							<li>
								<a href="http://127.0.0.1:8082/trade/collect" target="_blank" class="mpbtn_stores quick-links-a">
									<i class="stores"></i>
								</a>
								<div class="popup">
									我收藏的店铺
							...
							<li id="collectGoods">
								<a href="http://127.0.0.1:8082/trade/collect" target="_blank" class="mpbtn_collect quick-links-a">
									<i class="collect"></i>
								</a>
								<div class="popup">
									我的收藏
